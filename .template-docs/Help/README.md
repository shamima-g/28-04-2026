...
| Topic | Description |
|-------|-------------|
| [Template Sync](./Template-Sync.md) | Keep your project in sync with template updates |
...
**Keep my project up to date with the template**
→ [Template Sync Guide](./Template-Sync.md)
